...
title: Ceph国产化
catalog: true
tag: [OpenStack, ceph, 容器, kolla, 国产化, 麒麟, 鲲鹏]
---
...
我这里用的debian，由于debian的源中带的ceph版本就是12.2.11，构建的时候没有添加其他ceph源所以构建出来的还是旧版本，构建全程比较慢，所以在原有镜像 [debian-source-ceph-base](https://hub.docker.com/layers/debian-source-ceph-base/kolla/debian-source-ceph-base/train-aarch64/images/sha256-af149b1fb32033f94a0ad3184131638bbb24b192f50e8a1efa869152bd42be8b?context=explore)上进行修改，生成新的镜像，步骤大概记录下
